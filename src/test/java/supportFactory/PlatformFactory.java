...
import SupportEnums.Platform;
import SupportReadConfig.testconfig;

public class PlatformFactory {
	
	static Platform platform = Platform.valueOf(testconfig.config.get("platform"));
	
	static String desiredPlatformVersion = testconfig.config.get("platformVersion");
