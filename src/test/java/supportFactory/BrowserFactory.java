...
import SupportEnums.Browser;
import SupportReadConfig.testconfig;

public class BrowserFactory {
	
	static Browser browser = Browser.valueOf(testconfig.config.get("browser"));
	
	static String desiredBrowserVersion = testconfig.config.get("browserVersion");
